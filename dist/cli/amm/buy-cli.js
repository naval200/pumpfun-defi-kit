...
exports.buyTokensAMM = buyTokensAMM;
 ...
 */
async function buyTokensAMM() {
    const args = (0, cli_args_1.parseArgs)();
    if (args.help) {
        (0, cli_args_1.printUsage)('cli:amm-buy', [
    ...
    try {
        ...
        const requiredAmount = (0, amounts_1.solToLamports)(args.amount);
        console.log(`💰 Wallet balance: ${(0, amounts_1.formatLamportsAsSol)(balance)} SOL`);
        ...
        const buyResult = await (0, amm_1.buyAmmTokens)(connection, wallet, poolKey, requiredAmount, args.slippage || 100, feePayer || undefined);
